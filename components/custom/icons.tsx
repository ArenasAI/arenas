...
export const ArenasIcon = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 464 464" xmlns="http://www.w3.org/2000/svg" style={{ color: 'currentcolor' }}>
  <rect width="464" height="464" rx="100" ry="100" fill="black"/>
